...
const CONTACT_PHONE_DISPLAY = "0899 564 288";
const CONTACT_PHONE_LINK = "+359899564288";
const CONTACT_EMAIL = "iliev132607@gmail.com";

const MAP_URL =
  "https://www.google.com/maps/search/?api=1&query=Ruse%2C%20Bulgaria";

const EMBED_MAP_URL =
  "https://www.google.com/maps?hl=bg&q=Ruse%2C%20Bulgaria&z=13&output=embed";
        ...
        <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <article className={cardClass}>
            ...
            <a
              ...
              className="mt-2 inline-block break-all text-sm text-[#4b5d6d] transition hover:text-[#18b99f] dark:text-white/75"
            >
              {CONTACT_EMAIL}
            </a>
          </article>
          ...
          <article className={cardClass}>
            ...
            <a
              ...
              className="mt-2 inline-block text-sm text-[#4b5d6d] transition hover:text-[#18b99f] dark:text-white/75"
            >
              {isBg ? "Русе, България" : "Ruse, Bulgaria"}
            </a>
          </article>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={inputClass}
                    placeholder={
                      isBg ? "Тема на запитването" : "Enquiry subject"
                    }
                  />
                </div>
              </div>
