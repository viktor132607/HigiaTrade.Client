...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-[#d6dde3] bg-[#f4f6f8] text-[#263b4d] transition-colors dark:border-white/20 dark:bg-black dark:text-white">
          ...
          {benefits.map((item) => {
            ...
            return (
              <div key={item.titleBg} className="text-center">
                ...
                <h3 className="mt-3 text-xl font-semibold text-[#263b4d] dark:text-white">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 text-sm sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <div className="mt-4 grid gap-2 text-[#4b5d6d] dark:text-white/75">
            <Link to="/register" className="hover:text-[#18b99f]">
              {isBg ? "Регистрирай се" : "Register"}
            </Link>
            <Link to="/products" className="hover:text-[#18b99f]">
              {isBg ? "Продукти" : "Products"}
            </Link>
            <Link to="/orders" className="hover:text-[#18b99f]">
              {isBg ? "Проследяване на поръчки" : "Order tracking"}
            </Link>
            <Link to="/about" className="hover:text-[#18b99f]">
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2 text-[#4b5d6d] dark:text-white/75">
            <Link to="/login" className="hover:text-[#18b99f]">
              {isBg ? "Влизане" : "Sign in"}
            </Link>
            <Link to="/profile" className="hover:text-[#18b99f]">
              {isBg ? "Профил" : "Profile"}
            </Link>
            <Link to="/wishlist" className="hover:text-[#18b99f]">
              {isBg ? "Любими" : "Wishlist"}
            </Link>
            <Link to="/cart" className="hover:text-[#18b99f]">
              {isBg ? "Количка" : "Cart"}
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2 text-[#4b5d6d] dark:text-white/75">
            <Link to="/promotions" className="hover:text-[#18b99f]">
              {isBg ? "Промоции" : "Promotions"}
            </Link>
            <Link to="/new-products" className="hover:text-[#18b99f]">
              {isBg ? "Нови стоки" : "New products"}
            </Link>
            <Link to="/best-sellers" className="hover:text-[#18b99f]">
              {isBg ? "Най-продавани" : "Best sellers"}
            </Link>
            <Link to="/brands" className="hover:text-[#18b99f]">
        ...
        <div>
          ...
          <div className="mt-4 space-y-2 text-[#4b5d6d] dark:text-white/75">
