...
flowchart LR
    ...
    subgraph HygiaTrade["Система HygiaTrade"]
        UC1(["Регистрация"])
...
Диаграмата съответства на реалните backend entity класове и съзнателно не въвежда несъществуващи таблици като `Cart` или `Address`. В HygiaTrade поведението на количката се реализира чрез `Order`, а данните за адрес и доставка са вградени директно в записа на поръчката.
